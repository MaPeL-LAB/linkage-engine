...
| B1 — synthetic benchmark library | Corrected v2 evidence grid complete; v3 prospectively preregistered | stable seed-v1, immutable v2 evidence, new 84-family/336-instance v3 design, observable mechanism profiles, causal supervised label budgets, whole-family shards, serial governance preparation, and a resumable 10-worker driver | execute the approved v3 corpus externally; corpus completeness is not advisor qualification or operational validity |
