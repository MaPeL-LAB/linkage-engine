...
| B1 — synthetic benchmark library | Corrected v2 evidence grid complete | stable seed-v1, versioned 64-family/280-instance advisor-v2 design, three real link-only adapters, aggregate append-only registry, deterministic shards, failure retention, prospective family roles, stable Fellegi-Sunter scoring, and 9,800-run cell-complete evidence | expand recipe competitiveness and task representation only through a new prospective design; no operational claim |
