...
| `release_readiness_controls` | M8 | implemented | workflow_integrated | core_ci | Fail-closed private-candidate policy, generated error-code inventory, compatibility/API/artifact/security/model-card/rollback controls, and resumable aggregate synthetic scale tooling; release, publication, deployment, and operational validity remain blocked. |
