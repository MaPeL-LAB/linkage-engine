...
def evaluate_binary_scores(
    *,
    ...
    return PairValidationReport(
        ...
        average_precision=float(average_precision_score(target, probability_like)),
        roc_auc=float(roc_auc_score(target, probability_like)),
        brier_score=float(brier_score_loss(target, probability_like)),
